...
## tl:dr
I made a fully automated timelapse build pipeline with python, FFmpeg and a raspberry pi 4. It creates beautiful timelapses of Boston, MA using images from webcams installed by the National Parks Service in Boston on the [Dorchester Heights Monument](https://onemilliontweetmap.com/?center=42.3328188946806,-71.04534337297083&zoom=17&search=&timeStep=0&timeSelector=0&hashtag1=&hashtag2=sad&sidebar=yes&hashtagBattle=0&timeRange=0&timeRange=25&heatmap=0&sun=0&cluster=1) and [Bunker Hill Monument](https://onemilliontweetmap.com/?center=42.37656433712438,-71.0599757032469&zoom=17&search=&timeStep=0&timeSelector=0&hashtag1=&hashtag2=sad&sidebar=yes&hashtagBattle=0&timeRange=0&timeRange=25&heatmap=0&sun=0&cluster=1). 
...
```
ffmpeg -ss X -t N -i path/to/input.mp4 -s:v 1280x720 path/to/output.mp4
```
